...
|----|------|--------|--------|--------|--------|
| REF-001 | Fix command injection in git operations | Coordinator | S | Critical Security | ✅ PR #41 |
| REF-002 | Parallelize Level 3 annotation processing | Levels | M | 7x Performance | ✅ PR #45 |
| REF-003 | Complete file annotation reconstruction | Query | M | Data Quality | ✅ PR #43 |
| REF-004 | Add JSON schema validation | Query | S | Security | ✅ PR #48 |
| REF-005 | Fix UPDATE_THRESHOLDS ambiguity | Core | S | Logic Bug | ✅ PR #40 |
| REF-006 | Add missing type/constant exports | Core | S | API Completeness | ✅ PR #42 |
| REF-007 | Decompose pipeline.ts monolith | Coordinator | XL | Maintainability | ✅ PR #50 |
| REF-008 | Extract duplicate retry logic | Levels | M | DRY Violation | ✅ PR #49 |
...
| ID | Item | Module | Effort | Impact | Status |
|----|------|--------|--------|--------|--------|
| REF-009 | Add LLM response caching | Levels | M | 50% Cost Savings | ⏳ Pending |
| REF-010 | Abstract LLM provider interface | Levels | L | Flexibility | ⏳ Pending |
...
| REF-015 | Add metrics and cost tracking | Levels | M | Observability | ✅ PR #51 |
